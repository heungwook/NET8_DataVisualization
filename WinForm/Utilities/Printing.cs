	...
	public class PrintingManager : IDisposable
	{
        ...
        public void PrintPaint(Graphics graphics, Rectangle position)
		{
			...
			if(_chartImage != null)
			{
				...
				// Draw chart
				_chartImage.ChartGraph.InitGraphics(null);
				RenderingGraphicsGDI renderGraphicsGdi = new RenderingGraphicsGDI(graphics);
				_chartImage.Paint(renderGraphicsGdi, false);
