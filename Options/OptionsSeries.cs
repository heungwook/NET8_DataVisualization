...
{
    public class OptionsSeries
    {
        public bool cbSkipEmptyLabels;
        public bool cbLabelTopForMinusValue;
        public bool cbShowOverflowValues;
        public bool cbUseCustomBarColumnShape;
        public string csSvgXml;
        public SvgXmlInfo cSvgXmlShape;

        public OptionsSeries()
        {
            cbSkipEmptyLabels = false;
            cbLabelTopForMinusValue = false;
            cbShowOverflowValues = false;
            cbUseCustomBarColumnShape = false;
            csSvgXml = string.Empty;
            cSvgXmlShape = null;
        }
    }
}
