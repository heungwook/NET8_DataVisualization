...
#endif
{
	...
	internal enum RenderingType
	{
		...
		/// SVG AxisName
		/// </summary>
		[SuppressMessage("Microsoft.Naming", "CA1704:IdentifiersShouldBeSpelledCorrectly", MessageId = "Pdf")]
		Pdf,
    ...
    public partial class ChartGraphics
	{
		...
		private RenderingType _activeRenderingType2 = RenderingType.Gdi;

		// GDI+ rendering engine
		private IChartRenderingEngine RenderGraphics = null;
		public void InitGraphics(IChartRenderingEngine renderingEngine)
		{
			if (renderingEngine == null)
			{
				_activeRenderingType = RenderingType.Gdi;
				_activeRenderingType2 = RenderingType.Gdi;
				RenderGraphics = new RenderGDI();
			}
			else if (renderingEngine.GetType().Equals(typeof(RenderPDF)))
			{
				_activeRenderingType = RenderingType.Gdi;
				_activeRenderingType2 = RenderingType.Pdf;
				RenderGraphics = renderingEngine;
			}
			else if (renderingEngine.GetType().Equals(typeof(RenderPS)))
			{
				_activeRenderingType = RenderingType.Gdi;
				_activeRenderingType2 = RenderingType.PS;
				RenderGraphics = renderingEngine;
			}
		}
		...
		internal IChartRenderingEngine RenderingObject
		{
			get
			{
				...
				if (ActiveRenderingType == RenderingType.Gdi)
					return _gdiGraphics;
				else if (ActiveRenderingType == RenderingType.Pdf)
					return _pdfGraphics;
				else
					return _gdiGraphics;
				*/
		...
		internal RenderingType ActiveRenderingType2
		{
			get
			{
				return _activeRenderingType2;
			}
		}
		...
		internal IRenderingGraphics Graphics
		{
			get
			{
