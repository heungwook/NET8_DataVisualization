...
#endif
{
	...
	{
        public Options.OptionsLabelStyle cOptions;
		...
		public LabelStyle()
		{
            cOptions = new Options.OptionsLabelStyle();
		...
		internal void Paint( ChartGraphics graph, bool backElements )
		{
            ...
            using (StringFormat format = new StringFormat())
            {
                ...
                if (_axis.AxisPosition == AxisPosition.Left)
                {
                    ...
                    rectLabels.X -= labelSize + _axis.markSize; // * 1.5F; // 
                ...
                foreach (CustomLabel label in this._axis.CustomLabels)
                {
                    ...
                    // Options
                    if (cOptions.cbUseForceAlignment)
                    {
                        format.Alignment = cOptions.ceHorzAlignment;
                        format.LineAlignment = cOptions.ceVertAlignment;
                    }
