...
namespace Orion.DataVisualization.Charting
{
	...
	public class Cursor : IDisposable
	{
		...
		private	System.Windows.Forms.MouseEventArgs			_mouseMoveArguments = null;
		...
		internal void Cursor_MouseDown(object sender, System.Windows.Forms.MouseEventArgs e)
		{
			...
			if(e.Button == System.Windows.Forms.MouseButtons.Left && !GetPositionInPlotArea(new PointF(e.X, e.Y), false).IsEmpty)
			{
					...
					if(this._chartArea != null && this._chartArea.Common != null && this.GetAxis()!= null)
					{
						...
						if(!double.IsNaN(this._axis.ScaleView.Position) && !double.IsNaN(this._axis.ScaleView.Size))
						{
							...
							if(!insideChartArea)
							{
								...
								_mouseMoveArguments = new System.Windows.Forms.MouseEventArgs(e.Button, e.Clicks, e.X, e.Y, e.Delta);
