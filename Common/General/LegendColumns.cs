...
//				chartGraph.DrawRectangle(Pens.Red, absRectangle.X, absRectangle.Y, absRectangle.Width, absRectangle.Height);
				...
				Size singleWCharacterSize)
			{
				if(this.Image.Length > 0)
				{
					...
					{
						imageAttributes.SetColorKey(this.ImageTransparentColor.ToColor(), this.ImageTransparentColor.ToColor(), System.Drawing.Imaging.ColorAdjustType.Default);
					}
				...
				SizeF singleWCharacterSize)
			{
				...
				if(legendItem.Image.Length > 0)
				{
                    ...
                    if (image != null)
                    {
                        ...
                        {
                            imageAttributes.SetColorKey(legendItem.BackImageTransparentColor.ToColor(), legendItem.BackImageTransparentColor.ToColor(), System.Drawing.Imaging.ColorAdjustType.Default);
                        }
