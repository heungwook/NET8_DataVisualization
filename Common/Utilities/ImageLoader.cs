...
#if Microsoft_CONTROL
    namespace Orion.DataVisualization.Charting.Utilities
#else
...
#endif
{
    ...
    internal class ImageLoader : IDisposable, IServiceProvider
    {
        ...
        internal bool GetAdjustedImageSize(string name, IRenderingGraphics graphics, ref SizeF size)
        {
        ...
        /// <param name="graphics">Graphics used to calculate the image size.</param>
        /// <param name="size">Calculated size.</param>
        internal static void GetAdjustedImageSize(Image image, IRenderingGraphics graphics, ref SizeF size)
        {
            if (graphics != null)
            {
        ...
        internal static bool DoDpisMatch(Image image, IRenderingGraphics graphics)
        {
            return graphics.DpiX == image.HorizontalResolution && graphics.DpiY == image.VerticalResolution;
        }

        internal static Image GetScaledImage(Image image, IRenderingGraphics graphics)
        {
