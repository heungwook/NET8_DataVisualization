 ...
 this,
		...
		public void BeginTextEditing()
		{
			...
			if(this.Chart != null && this.AllowTextEditing)
			{
				...
				_editTextBox.BackColor = ((this.BackColor.IsEmpty) ? Color.White : this.BackColor).ToColor();
				_editTextBox.ForeColor = this.ForeColor.ToColor();
...
System.Drawing.Image		graphicsImage = null;
			...
			if(GetGraphics() == null &&	this.Common != null)
			{
				...
				if (Common.graph.ActiveRenderingType2 == RenderingType.Pdf)
					tempChartGraph.Graphics = new RenderingGraphicsPDF(Common.graph.Graphics.GraphicsPdf, graphics);
				else if (Common.graph.ActiveRenderingType2 == RenderingType.Gdi)
					tempChartGraph.Graphics = new RenderingGraphicsGDI(graphics);
				else if (Common.graph.ActiveRenderingType2 == RenderingType.PS)
					tempChartGraph.Graphics = new RenderingGraphicsPS(Common.graph.Graphics.GraphicsPS, graphics);
